...
import { TrendingUp, CreditCard, PiggyBank, Landmark, Calculator, BarChart2, Sparkles, Brain, AlertCircle, GitCompare, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#070A12] px-5 pt-14 pb-28 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <p className="font-body text-[13px] text-white/35">Everything you need to make smarter financial decisions</p>
        </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <motion.div
                  ...
                  className="w-full relative overflow-hidden rounded-2xl p-5 text-left cursor-pointer"
                  style={{
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3.5">
                      ...
                      >
                        <Sparkles size={20} style={{ color: '#A78BFA' }} strokeWidth={2} />
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <h3
                          className="text-[18px] tracking-tight text-white/95 font-extrabold"
                          style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                        >
                          AI Financial Advisor
                        </h3>
                        <p
                          className="text-[12px] text-white/35 mt-1 leading-normal"
                          style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                        >
                    ...
                    <div
                      className="px-3.5 py-1.5 rounded-full flex items-center gap-1.5 flex-shrink-0"
                    ...
                    >
                      ...
                      <span className="text-[11px] font-bold" style={{ color: '#C084FC' }}>→</span>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <motion.div
                    animate={{ x: ['-100%', '200%'] }}
                    transition={{ duration: 3, repeat: Infinity, ease: 'linear', delay: 2.0 }}
                    className="absolute inset-y-0 w-1/3 skew-x-12 pointer-events-none"
                    style={{ background: 'linear-gradient(90deg, transparent, rgba(255,255,255,0.06), transparent)' }}
                  />
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3.5">
                      <div
                        className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                        style={{ background: 'rgba(0,229,255,0.20)', border: '1px solid rgba(0,229,255,0.35)' }}
                      >
                        <GitCompare size={20} style={{ color: '#00E5FF' }} strokeWidth={2} />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p
                          className="text-[10px] uppercase tracking-widest font-bold mb-0.5"
                          style={{ color: '#00E5FF', fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                        >
                          COMING SOON
                        </p>
                        <h3
                        ...
                        <p
                          ...
                          style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                        >
                          Compare savings accounts, FDs, loans side by side
                        </p>
                      </div>
                    </div>
                    <div
                      className="px-3.5 py-1.5 rounded-full flex items-center flex-shrink-0"
                      style={{ background: 'rgba(0,229,255,0.15)', border: '1px solid rgba(0,229,255,0.25)' }}
                    >
                      <span
                        className="text-[11px] font-bold"
                        style={{ color: '#00E5FF', fontFamily: "'Plus Jakarta Sans', sans-serif" }}
              ...
              <div>
                <motion.p
                  ...
                  className="text-[10px] tracking-widest uppercase text-white/25 mb-4 font-bold"
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                >
                ...
                <div className="flex flex-col gap-3">
                  {toolConfig.filter(item => item.id !== 'ai-advisor').map((item, i) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className="flex items-center justify-between p-4 rounded-xl text-left w-full cursor-pointer transition-all"
                        style={{
                      ...
                      >
                        <div className="flex items-center gap-3.5 min-w-0">
                          ...
                          <div className="min-w-0">
                            <h4
                              className="text-[14px] leading-tight text-white/95 font-bold"
                              style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                            >
                              {t[item.labelKey]}
                            </h4>
                            <p className="font-body text-[11px] text-white/35 mt-0.5 leading-normal truncate">
                              {t[item.descKey]}
                            </p>
                          </div>
                        </div>
                        <ChevronRight size={16} className="text-white/20 flex-shrink-0 ml-2" />
                      </motion.button>
                    );
                  })}
                </div>
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            className="fixed bottom-24 left-1/2 -translate-x-1/2 px-5 py-3 rounded-xl z-50 text-[13px] font-semibold flex items-center gap-2 border shadow-2xl"
            style={{
